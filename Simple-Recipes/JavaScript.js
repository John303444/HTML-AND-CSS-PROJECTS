...
var closeBtn = document.getElementByClassName('close-btn');
...
document.getElementById('contactForm').addEventListener('submit',
    function (event) {
        ...
        //for an email addresssuch as the@ and . and the text
        ...
        if(!firstName || !lastName || !phone || !message) {
            ...
            valMsg.innerHTML = '<p style="color: red;">Thank you for your submitting!</p>';
        }
